...
#abrindo o site
driver.get("https://gtm-latam-uat.onesourcetax.com/module-selection/387/login")
...
# preencher o campo de usuário - JMunari
campo_user.clear()
campo_user.send_keys("PZJQ9S")
...
try:
    ...
    app_element = wait.until(EC.element_to_be_clickable(
        (By.XPATH, '//img[@alt="OSGT_QA"]/parent::a[@class="storeapp-details-link"]')
    ))
